...
### Getting the server running issue
I needed to run this and make sure to have the latest node and npm in order to get the server running.

```
npm install history@1.13.x --save
npm install warning --save
```
